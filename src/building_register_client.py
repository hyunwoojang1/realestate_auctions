...
# (2026-07-20 실측) BldRgstService_v2는 500(구 엔드포인트) — 건축HUB 이관 후 BldRgstHubService가 정상.
BLD_TITLE_ENDPOINT = "https://apis.data.go.kr/1613000/BldRgstHubService/getBrTitleInfo"
